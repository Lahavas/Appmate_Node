...
module.exports = {
  up: (queryInterface, Sequelize) => {
    ...
    return queryInterface.bulkInsert('ProjectLikes', [
      ...
      { id: 11, projectId: 2, likeUserId: 24, createdAt: new Date(), updatedAt: new Date()},
      { id: 12, projectId: 2, likeUserId: 25, createdAt: new Date(), updatedAt: new Date()},
      { id: 13, projectId: 2, likeUserId: 26, createdAt: new Date(), updatedAt: new Date()},
      { id: 14, projectId: 2, likeUserId: 28, createdAt: new Date(), updatedAt: new Date()},
      { id: 15, projectId: 2, likeUserId: 39, createdAt: new Date(), updatedAt: new Date()},
      ...
      { id: 33, projectId: 8, likeUserId: 12, createdAt: new Date(), updatedAt: new Date()},
      { id: 34, projectId: 8, likeUserId: 13, createdAt: new Date(), updatedAt: new Date()},
      { id: 35, projectId: 8, likeUserId: 14, createdAt: new Date(), updatedAt: new Date()},
